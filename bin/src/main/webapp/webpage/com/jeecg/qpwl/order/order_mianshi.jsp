				...
				<td class="value">
					...
					<tr>
						...
						<td class="value"  colspan="3" >
						  	 	<textarea id="inviteRemarks" style="width:99%;height: 100px;" class="inputxt" rows="6" name="inviteRemarks"  datatype="*"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">面试备注</label>
						</td>
					</tr>
			</table>
			<br/>
