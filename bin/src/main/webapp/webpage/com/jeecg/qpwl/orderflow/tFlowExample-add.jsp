...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="tFlowExampleController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="tFlowExampleController.do?tFlowExecuteHistoryList&id=${tFlowExamplePage.id}" icon="icon-search" title="历史环节" id="tFlowExecuteHistory"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
