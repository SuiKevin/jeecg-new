		...
		<tr style="height: 50px;">
				...
				<table style="width: 99%;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value" style="width: 20%"><label>${tOrderIngPage.inviteStore}</label></td>
						<td class="value" align="right" style="width: 13%">
			...
			<table style="width: 99%;" cellpadding="0" cellspacing="1" class="formtable">
						...
						<td class="value">
									<t:dictSelect field="ruzhiFushiResult" type="list"  datatype="*"  typeGroupCode="fsjg"   defaultVal="${tOrderIngPage.ruzhiFushiResult}" hasLabel="false"  title="复试是否通过" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									<t:dictSelect field="ruzhiHetongResult" type="list"  datatype="*"  typeGroupCode="sftdht"   defaultVal="${tOrderIngPage.ruzhiHetongResult}" hasLabel="false"  title="是否签订劳动合同" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									<t:dictSelect field="ruzhiTijianResult" type="list"  datatype="*"  typeGroupCode="tjjg"   defaultVal="${tOrderIngPage.ruzhiTijianResult}" hasLabel="false"  title="体检结果" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									<t:dictSelect field="ruzhiPeixunResult" type="radio"  datatype="*"  typeGroupCode="yesorno"   defaultVal="${tOrderIngPage.ruzhiPeixunResult}" hasLabel="false"  title="培训结果" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									<t:dictSelect field="ruzhiZhusuResult" type="radio"  datatype="*"  typeGroupCode="yesorno"   defaultVal="${tOrderIngPage.ruzhiZhusuResult}" hasLabel="false"  title="是否住宿" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									<t:dictSelect field="ruzhiShanggangResult" type="radio"  datatype="*"  typeGroupCode="yesorno"   defaultVal="${tOrderIngPage.ruzhiShanggangResult}" hasLabel="false"  title="是否上岗" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value"  colspan="3" >
						  	 <textarea  style="width:99%;height: 80px;" class="inputxt" rows="6" name="inviteRemarks"  datatype="*"  ignore="ignore" ></textarea>
						</td>
					</tr>
			</table>
