...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tOrderHisList" checkbox="true" pagination="true" fitColumns="true" title="历史工单" actionUrl="tOrderHisController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="tOrderHisController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgOpenOpt  width="900" height="600" url="tOrderHisController.do?lookHis&id={id}" title="历史详情" urlclass="ace_button" urlfont="fa-file" urlStyle="background-color: #6666CC;"></t:dgOpenOpt>
