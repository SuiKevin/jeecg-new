			...
			<table style="width: 99%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					<td align="right">
						...
						<td class="value">
									<t:dictSelect field="pickResult" type="list"  datatype="*"  typeGroupCode="jsjg"   defaultVal="${tOrderIngPage.pickResult}" hasLabel="false"  title="接送结论" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">接送结果</label>
						</td>
						<td align="right">
							<label class="Validform_label">
								接送时间:
						...
						<td class="value">
									   <input id="pickDate" name="pickDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  datatype="*"  ignore="ignore"  value='${tOrderIngPage.pickDate}'/>
							<span class="Validform_checktip"></span>
				...
				<tr>
						...
						<td class="value"  colspan="3" >
						  	 <textarea  style="width:99%;height:80px" class="inputxt" rows="6"  datatype="*"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
