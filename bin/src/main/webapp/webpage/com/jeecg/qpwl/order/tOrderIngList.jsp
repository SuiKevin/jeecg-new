...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tOrderIngList" checkbox="false" pagination="true" fitColumns="true" title="在途工单" actionUrl="tOrderIngController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="工作经验"  field="gzjy"  query="true"  queryMode="group"  width="60"></t:dgCol>
   <t:dgCol title="目前职位"  field="mqjob"  queryMode="single"  width="80"></t:dgCol>
   <t:dgCol title="当前环节"  field="taskName"  queryMode="single"  width="50"></t:dgCol>
   ...
   <t:dgOpenOpt exp="taskName#eq#邀约" width="810" height="600" url="tOrderIngController.do?goYaoyue&id={id}" title="邀约" urlclass="ace_button" urlfont="fa-phone" urlStyle="background-color: red;"></t:dgOpenOpt>
   <t:dgOpenOpt exp="taskName#eq#面试" width="820" height="600" url="tOrderIngController.do?goMianshi&id={id}" title="面试" urlclass="ace_button" urlfont="fa-users" urlStyle="background-color: red;"></t:dgOpenOpt>
   <t:dgOpenOpt exp="taskName#eq#审核" width="820" height="600" url="tOrderIngController.do?goShenhe&id={id}" title="审核" urlclass="ace_button" urlfont="fa-check" urlStyle="background-color: red;"></t:dgOpenOpt>
   <t:dgOpenOpt exp="taskName#eq#接送" width="820" height="600" url="tOrderIngController.do?goJiedai&id={id}" title="接送" urlclass="ace_button" urlfont="fa-car" urlStyle="background-color: red;"></t:dgOpenOpt>
   <t:dgOpenOpt exp="taskName#eq#上岗" width="820" height="600" url="tOrderIngController.do?goShanggang&id={id}" title="上岗" urlclass="ace_button" urlfont="fa-truck" urlStyle="background-color: red;"></t:dgOpenOpt>
   <t:dgOpenOpt exp="taskName#eq#入职" width="820" height="600" url="tOrderIngController.do?goRuzhi&id={id}" title="入职" urlclass="ace_button" urlfont="fa-cubes" urlStyle="background-color: red;"></t:dgOpenOpt>
   <t:dgOpenOpt exp="taskName#eq#收款" width="900" height="600" url="tOrderIngController.do?goShoukuan&id={id}" title="收款" urlclass="ace_button" urlfont="fa-money" urlStyle="background-color: red;"></t:dgOpenOpt>
   <t:dgOpenOpt width="1050" height="670" url="tOrderIngController.do?doResumeView&id={id}" title="简历详情" urlclass="ace_button" urlfont="fa-user"></t:dgOpenOpt>
