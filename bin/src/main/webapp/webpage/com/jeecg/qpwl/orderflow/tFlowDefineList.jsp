...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tFlowDefineList" checkbox="true" fitColumns="true" title="流程定义表" actionUrl="tFlowDefineController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="起流程(空跑)"  message="确定起流程吗" url="tFlowDefineController.do?doStartFlow&id={id}&flowCode={flowCode}"  urlclass="ace_button" urlfont="fa-bullseye" urlStyle="background-color:#18a689;"/>
   <t:dgDelOpt title="起流程(挂工单)"  message="确定起流程吗" url="tFlowDefineController.do?doStartFlowParam&id={id}&flowCode={flowCode}"  urlclass="ace_button" urlfont="fa-bullseye" urlStyle="background-color:#008B00;"/>
