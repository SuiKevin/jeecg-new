...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tFlowExampleList" checkbox="true" fitColumns="true" title="在途工单" actionUrl="tFlowExampleController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="tFlowExampleController.do?doDel&id={id}"  urlclass="ace_button" urlfont="fa-trash-o"/>
   <t:dgDelOpt title="完成任务" url="tFlowExampleController.do?doComplete&id={id}&instanceId={instanceId}"  urlclass="ace_button" urlfont="fa-trash-o"/>
