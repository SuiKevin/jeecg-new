  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="qpZpcompanyController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="width:400px;" class="inputxt" rows="6" id="companyInfo" name="companyInfo"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="width:400px;" class="inputxt" rows="6" id="jobInfo" name="jobInfo"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="width:400px;" class="inputxt" rows="6" id="jingyan" name="jingyan"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="width:400px;" class="inputxt" rows="6" id="address" name="address"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="width:400px;" class="inputxt" rows="6" id="money" name="money"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
