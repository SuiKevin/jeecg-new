...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="qpZpcompanyList" checkbox="false" pagination="true" fitColumns="true" title="招聘企业信息" actionUrl="qpZpcompanyController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="qpZpcompanyController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="qpZpcompanyController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="qpZpcompanyController.do?goUpdate" funname="update"></t:dgToolBar>
