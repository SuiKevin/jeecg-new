...
<body>
		...
		<table style="width: 400px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value" >
						  	 	<textarea id="companyInfo" style="width:400px;" class="inputxt" rows="6" name="companyInfo"  ignore="ignore" >${qpZpcompanyPage.companyInfo}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" >
						  	 	<textarea id="jobInfo" style="width:400px;" class="inputxt" rows="6" name="jobInfo"  ignore="ignore" >${qpZpcompanyPage.jobInfo}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" >
						  	 	<textarea id="jingyan" style="width:400px;" class="inputxt" rows="6" name="jingyan"  ignore="ignore" >${qpZpcompanyPage.jingyan}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" >
						  	 	<textarea id="address" style="width:400px;" class="inputxt" rows="6" name="address"  ignore="ignore" >${qpZpcompanyPage.address}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" >
						  	 	<textarea id="money" style="width:400px;" class="inputxt" rows="6" name="money"  ignore="ignore" >${qpZpcompanyPage.money}</textarea>
							<span class="Validform_checktip"></span>
