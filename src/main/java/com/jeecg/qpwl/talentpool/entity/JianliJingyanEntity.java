 ...
 */
@Entity
@Table(name = "jianli_jingyan", schema = "")
@SuppressWarnings("serial")
public class JianliJingyanEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="KSSJ",nullable=true,length=20)
	...
	@Column(name ="JSRQ",nullable=true,length=50)
