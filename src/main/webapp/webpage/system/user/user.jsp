...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser" beforeSubmit="setOrgIds">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr  style="display:none;">
			<td align="right">  <t:mutiLang langKey="common.department"/>:</td>
			<td class="value"  >
                <input id="departname" name="departname" type="text" readonly="readonly" class="inputxt"  value="${departname}">
        ...
        <tr style="display:none">
            ...
            <td class="value">
                <t:dictSelect id="devFlag" field="devFlag" typeGroupCode="dev_flag" hasLabel="false" defaultVal="0" type="radio"></t:dictSelect>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
	</table>
