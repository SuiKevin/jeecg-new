...
<div class="easyui-layout" fit="true">
  ...
  <div style="margin-top: -20px;">
  	...
  	<div class="div_bg_card" id="jianliOnlineListtb">
  		<table>
  ...
  <t:datagrid name="jianliOnlineList" checkbox="true" fitColumns="true" title="" actionUrl="jianliOnlineController.do?datagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="网站类型"  field="website"  hidden="true"  query="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="省份"  field="province"  hidden="true"  query="true"  queryMode="single"  width="40"></t:dgCol>
   <t:dgCol title="城市"  field="city"  query="false"  queryMode="single"  width="40"></t:dgCol>
   <t:dgCol title="区县"  field="town"  query="false"  queryMode="single"  width="40"></t:dgCol>
   <t:dgCol title="职位大类"  field="jobtype1"  hidden="true"  query="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="职位小类"  field="jobtype2"  hidden="true"  query="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="职位详情"  field="jobtype3"  query="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="姓名"  field="name"  query="false"  queryMode="single"  width="60"></t:dgCol>
   ...
   <t:dgCol title="现居地"  field="xjzd"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="期望工作地"  field="qwgzd" hidden="true"  queryMode="single"  width="60"></t:dgCol>
   ...
   <t:dgCol title="更新时间"  field="gxsj"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgOpenOpt width="1150" height="600" url="jianliOnlineController.do?doResumeView&id={id}&viewFrom=jianli_business" title="查看简历" urlclass="ace_button" urlfont="fa-file" urlStyle="background-color: #1C86EE;"></t:dgOpenOpt>
  </t:datagrid>
  </div>
  </div>
 </div>
...
function delCgForm(myID,type){//测试
    if(type == "1"){
    	createdialog('获取联系方式 ', '该简历您已经获取过联系方式，是否再次获取。获取联系方式将消耗1个积分', "jianliOnlineController.do?doQueryPhoneNo&id="+myID,"获取联系方式");
    }else{
    	createdialog('获取联系方式 ', '确定是否获取联系方式,获取联系方式将扣除1个积分', "jianliOnlineController.do?doQueryPhoneNo&id="+myID,"获取联系方式");
    }
...
function loadCrty(){
 ...
 function laodRemotData(){
    ...
    data.ageStart = $("#ageStart").val();
 	...
 	//doSubmit("jianliOnlineController.do?datagrid","jianliOnlineList",data);
 	jianliOnlineListsearch();
 	//$("#panelloadingDiv").hide();
 }
 function queryReset(){//重置
 	searchReset("jianliOnlineList");
 }
 function inputResume(){//简历录入
 	//openwindow('简历录入','jianliOnlineController.do?goAdd','jianliOnlineList',1150,600);
