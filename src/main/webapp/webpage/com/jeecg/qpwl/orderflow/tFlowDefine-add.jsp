...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="tFlowDefineController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="flowCode" name="flowCode" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
			...
			<td class="value">
		     	 <input id="flowName" name="flowName" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
				<span class="Validform_checktip"></span>
