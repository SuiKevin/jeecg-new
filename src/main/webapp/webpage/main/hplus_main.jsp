        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    ...
                    <div class="logo-element">秦聘网络科技公司
                    </div>
                    <br/>
                </li>
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="秦聘网络科技有限公司人才招聘系统" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
                ...
                <!-- update-start--Author: chenj Date:20160812 for: TASK #1269 【ace h+】风格无用的右上角功能隐藏，暂时注释掉 -->
                   <li class="dropdown">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                            <i class="fa fa-envelope"></i>通知 11<span id="noticeCount2" class="label label-warning">0</span>
                        </a>
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                            <i class="fa fa-bell"></i>待处理<span id="noticeCount3" class="label label-primary">0</span>
                        </a>
                        <ul class="dropdown-menu dropdown-alerts">
                            <li class="divider"></li>
                            <li>
                     ...
                     <li class="dropdown">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                            <i class="fa fa-money"></i>积分<span id="noticeCount3" class="label label-primary"></span>
                        </a>
                        <ul class="dropdown-menu dropdown-alerts">
                            <li class="divider"></li>
                            <li>
                                <div class="text-center link-block">
                                    <a class="" href="javascript:goJifen();">
                                        <strong>查看积分</strong>
                                        <i class="fa fa-angle-right"></i>
                                    </a>
                                </div>
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                            <i class="fa fa-bell"></i> 超时<span class="label label-red">0</span>
                        </a>
                        <ul class="dropdown-menu dropdown-alerts">
                            <li>
                                <a>
                                    <div>
                                        <i class="fa fa-envelope fa-fw"></i> 超时
...
<script>
    ...
    $(document).ready(function(){
    	...
    	//加载数量信息
    	var orderCount = "noticeController.do?getOrderCount";
        jQuery.ajax({
            url:orderCount,
            type:"GET",
            dataType:"JSON",
            ...
            success:function(data){
                ...
                if(data.success){
                	var noticeCount = data.obj.noticeCount;
                	 if(noticeCount>99){
                        $("#noticeCount2").html(noticeCount);
                    }else{
                        $("#noticeCount2").html(noticeCount);
                    }
                    var waitCont = data.obj.waitCont;
                    if(waitCont>99){
                        $("#noticeCount3").html(waitCont);
                    }else{
                        $("#noticeCount3").html(waitCont);
                    }
                }
    ...
    function goAllMessage(){
        var addurl = "tOrderIngController.do?list";
        createdetailwindow("通知", addurl, 800, 400);
    }
    function goJifen(){
        var addurl = "qpJifenController.do?seeMyJifen&load=detail&id=111111111";
        createdetailwindow("积分", addurl, 600, 300);
    }
